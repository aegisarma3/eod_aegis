...
_reezo_eod_action_loudspeaker = _soldier addAction ['<t color="#FF33CC">'+"Loudspeaker (Evacuate Civilians)"+'</t>', "\eod\reezo_eod_action_loudspeaker_evacuate.sqf", [_soldier,_range,_probability,_interval], 0, false, true, "",""];
