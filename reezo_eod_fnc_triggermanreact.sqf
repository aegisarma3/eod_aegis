...
if (animationState _triggerman == "AmovPercMstpSsurWnonDnon" OR _triggerman hasWeapon "Makarov" OR _triggerman hasWeapon "UZI_EP1") exitWith {};
...
switch (true) do
{
	...
	case (_rnd > 0.10 && _rnd < 0.55) : //Fights..
	{
		...
		if (_rnd < 0.5) then
		{
			_triggerman addMagazine "8Rnd_9x18_Makarov"; //..with a Makarov
			_triggerman addMagazine "8Rnd_9x18_Makarov";
			_triggerman addWeapon "Makarov";
		    _triggerman selectWeapon "Makarov";
