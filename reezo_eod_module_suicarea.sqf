...
if (_this getVariable "reezo_eod_interval" <= 1) exitWith { [_this, _this getVariable "reezo_eod_range"] call reezo_eod_fnc_spawnsuic };
...
while {alive _this} do
{
	...
	{
		[_this, _this getVariable "reezo_eod_range"] call reezo_eod_fnc_spawnsuic;
	};
