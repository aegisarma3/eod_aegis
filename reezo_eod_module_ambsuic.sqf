...
if (isServer) then
{
	...
	reezo_eod_fnc_spawnsuic = compile preprocessFileLineNumbers "x\eod\addons\eod\reezo_eod_fnc_spawnsuic.sqf";
	reezo_eod_module_ambsuic_loop = compile preprocessFileLineNumbers "x\eod\addons\eod\reezo_eod_module_ambsuic_loop.sqf";
	reezo_eod_fnc_suicidebomber_scan = compile preprocessFileLineNumbers "x\eod\addons\eod\reezo_eod_fnc_suicidebomber_scan.sqf";
